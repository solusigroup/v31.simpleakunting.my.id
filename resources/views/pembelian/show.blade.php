...
@section('title', 'Detail Pembelian - Simple Akunting')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Detail Faktur #{{ $pembelian->no_faktur }}</h1>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-{{ $pembelian->status_pembayaran == 'Lunas' ? 'success' : 'warning' }}">{{ $pembelian->status_pembayaran }}</span>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>: {{ \Carbon\Carbon::parse($pembelian->tanggal_faktur)->format('d F Y') }}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-6 text-end">
                            <h4>Total Tagihan</h4>
                            <h2 class="text-primary">Rp {{ number_format($pembelian->total, 2, ',', '.') }}</h2>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-end fw-bold">Rp {{ number_format($pembelian->total, 2, ',', '.') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
