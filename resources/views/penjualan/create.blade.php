            ...
            <tr id="row_${rowCount}">
                <td>
                    <select class="form-select form-select-sm" name="details[${rowCount}][id_barang]" onchange="updateHarga(${rowCount})" required>
                        ...
                        ${barangData.map(b => `<option value="${b.id_barang}" data-harga="${b.harga_jual}" data-barcode="${b.barcode || ''}" data-kode="${b.kode_barang}">${b.kode_barang} - ${b.nama_barang} (Stok: ${b.stok_saat_ini})</option>`).join('')}
                    </select>
                </td>
                <td>
                    <input type="number" class="form-control form-control-sm" id="harga_${rowCount}" readonly>
                </td>
                <td>
