...
@section('title', 'Edit Pelanggan - Simple Akunting')
                    ...
                    <form action="{{ route('pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('saldo_awal_piutang') is-invalid @enderror" id="saldo_awal_piutang" name="saldo_awal_piutang" value="{{ old('saldo_awal_piutang', $pelanggan->saldo_awal_piutang) }}" min="0" step="0.01" required>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="text" class="form-control" value="{{ number_format($pelanggan->saldo_terkini_piutang, 2, ',', '.') }}" disabled>
                            </div>
                        </div>
