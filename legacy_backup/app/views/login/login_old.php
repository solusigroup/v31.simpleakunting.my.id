...
<body>
    <div class="main-container">
        <div class="login-wrapper">
            ...
            <div class="col-12 col-lg-6 login-form-side">
                <div class="text-center mb-4">
                    <i class="bi bi-journal-richtext brand-icon"></i>
                </div>
        ...
        <footer class="login-footer">
            &copy; <?php echo date('Y'); ?> - SIMPLE AKUNTING created by <a href="https://v2.simpleakunting.biz.id" target="_blank">Kurniawan @Simple Akunting</a>
        </footer>
    </div>
</body>
</html>
